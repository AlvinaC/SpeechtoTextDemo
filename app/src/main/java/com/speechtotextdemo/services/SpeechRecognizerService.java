package com.speechtotextdemo.services;
...
import com.speechtotextdemo.activity.MainActivity;
...
/**
 * Created by alvina.rasquinha on 29/03/18.
 */
...
public class SpeechRecognizerService extends Service
{
    ...
    public int onStartCommand(final Intent intent, final int flags,
                              final int startId) {
        Message msg = new Message(); msg.what = MSG_RECOGNIZER_START_LISTENING;
        try {
    ...
    protected class SpeechRecognitionListener implements RecognitionListener
    {
        ...
        public void onResults(Bundle results)
        {
            ...
            Log.d(TAG, result);
            MainActivity.mVoiceInputTv.setText(result);
            Message message = Message.obtain(null, MSG_RECOGNIZER_START_LISTENING);
            try
            {
                mServerMessenger.send(message);
